...
import SimpleBottomNavigation from "./BottomNavComponent.js";

const FooterEx = () => (
  <>
    <Grid style={{ color: '#F7ECDE', backgroundColor: '#2C3333'}} container spacing={2}>

      <Grid item md={12} lg={6}>

        <Grid style={{ color: '#F7ECDE'}} align={"left"} gutterBottom color={"textSecondary"}>
          ABOUT US
        </Grid>
